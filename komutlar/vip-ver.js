...
await member.roles.add('814859464804794378')//vip rol id yaz
message.channel.send(new MessageEmbed().setImage(`https://media.discordapp.net/attachments/697145772801785876/716671769355747348/1.gif`).setFooter(`Developed By RedZenom`).setDescription(`${member} **Adlı Kullanıcı** ${message.author} **Tarafından VİP Rolü Verildi** \n**Verilen Rol:** <@&814859464804794378>`)).then(msg => msg.delete({timeout: 4000}))}
exports.conf = { enabled: true, guildOnly: true , aliases: ["vip-ver"]}
exports.help = { name: "vip-ver"}